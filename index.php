...
<head>
  ...
  <meta name="description" content="desenvolvedor web, pai, devoro conteúdos da área, traduzo artigo para o Tuts+, compartilho o que aprendo, entusiasta em qualquer coisa digital e cabeça dura.">
  <meta name="keywords" content="thierry rene, desenvolvedor web, tradutor, webdev, webdesign">
  <meta name="copyright" content="2009-2015 Thierry Rene Web Dev.">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <img id="thierry-photo" class="img-responsive img-circle" src="img/photo.png" alt="Thierry Rene Web Developer">
          
          <div class="intro">
            <span id="name" class="name">Thierry Rene</span>
            <hr id="star-hr" class="star-hr">
            <span id="prof" class="skills">Web Developer Front End &<br class="visible-xs"> UI / UX Entusiast</span>
          </div>
      ...
      <div class="row">
        ...
        <article>
          ...
          <div class="col-md-12 text-center" >
            ...
            <p class="lead">Meu nome é <strong>Thierry Rene</strong>.
              <br>Sou desenvolvedor web front end, natural de <strong>São Paulo - SP</strong>.</p>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 text-center">
          ...
          <hr class="book-hr">
          <div class="row">
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3"><svg class="svg-icons" viewBox="0 0 128 128">
  ...
  <footer class="text-center">
    ...
    <div id="footer-copy">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h5>Copyright &copy; <br class="visible-xs">Thierry Rene Web Dev. 2015</h5>
          </div>
        </div>
